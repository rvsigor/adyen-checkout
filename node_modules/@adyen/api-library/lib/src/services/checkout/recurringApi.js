...
class RecurringApi extends service_1.default {
    ...
    */
    async forward(checkoutForwardRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/forward`;
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(checkoutForwardRequest, "CheckoutForwardRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "CheckoutForwardResponse");
    }
    /**
