...
class DonationsApi extends service_1.default {
    ...
    */
    async donationCampaigns(donationCampaignsRequest, requestOptions) {
        ...
        const request = objectSerializer_1.ObjectSerializer.serialize(donationCampaignsRequest, "DonationCampaignsRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "DonationCampaignsResponse");
    }
    /**
    ...
    */
    async donations(donationPaymentRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(donationPaymentRequest, "DonationPaymentRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "DonationPaymentResponse");
    }
}
