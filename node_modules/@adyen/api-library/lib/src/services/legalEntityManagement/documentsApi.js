 ...
 */
class DocumentsApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async getDocument(id, skipContent, requestOptions) {
        const endpoint = `${this.baseUrl}/documents/{id}`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
        ...
        if (hasDefinedQueryParams) {
            ...
            if (skipContent)
                requestOptions.params["skipContent"] = skipContent;
        }
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "Document");
    }
    /**
    ...
    * @return {@link Document }
    */
    async updateDocument(id, document, requestOptions) {
        const endpoint = `${this.baseUrl}/documents/{id}`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(document, "Document");
    ...
    * @return {@link Document }
    */
    async uploadDocumentForVerificationChecks(document, requestOptions) {
