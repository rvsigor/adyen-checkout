 ...
 */
export declare class SCAAssociationManagementApi extends Service {
    ...
    */
    approveAssociation(approveAssociationRequest: ApproveAssociationRequest, requestOptions?: IRequest.Options): Promise<ApproveAssociationResponse>;
    /**
    ...
    */
    listAssociations(entityType: ScaEntityType, entityId: string, pageSize: number, pageNumber: number, requestOptions?: IRequest.Options): Promise<ListAssociationsResponse>;
    /**
    ...
    * @return {@link void }
    */
    removeAssociation(removeAssociationRequest: RemoveAssociationRequest, requestOptions?: IRequest.Options): Promise<void>;
}
