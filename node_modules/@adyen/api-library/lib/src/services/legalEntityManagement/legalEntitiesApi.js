...
exports.LegalEntitiesApi = void 0;
 ...
 */
class LegalEntitiesApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async checkLegalEntitysVerificationErrors(id, requestOptions) {
        ...
        return objectSerializer_1.ObjectSerializer.deserialize(response, "VerificationErrors");
    }
    /**
    ...
    */
    async confirmDataReview(id, requestOptions) {
        const endpoint = `${this.baseUrl}/legalEntities/{id}/confirmDataReview`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "DataReviewConfirmationResponse");
    }
    /**
    ...
    */
    async createLegalEntity(legalEntityInfoRequiredType, requestOptions) {
        const endpoint = `${this.baseUrl}/legalEntities`;
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(legalEntityInfoRequiredType, "LegalEntityInfoRequiredType");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "LegalEntity");
    }
    /**
    ...
    */
    async getAllBusinessLinesUnderLegalEntity(id, requestOptions) {
        ...
        return objectSerializer_1.ObjectSerializer.deserialize(response, "BusinessLines");
    }
    /**
    ...
    * @return {@link LegalEntity }
    */
    async getLegalEntity(id, requestOptions) {
    ...
    * @return {@link void }
    */
    async requestPeriodicReview(id, requestOptions) {
    ...
    * @return {@link LegalEntity }
    */
    async updateLegalEntity(id, legalEntityInfo, requestOptions) {
        const endpoint = `${this.baseUrl}/legalEntities/{id}`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(legalEntityInfo, "LegalEntityInfo");
...
//# sourceMappingURL=legalEntitiesApi.js.map