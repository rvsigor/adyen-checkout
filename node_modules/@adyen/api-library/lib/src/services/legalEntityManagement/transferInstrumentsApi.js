...
exports.TransferInstrumentsApi = void 0;
 ...
 */
class TransferInstrumentsApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async createTransferInstrument(transferInstrumentInfo, requestOptions) {
        const endpoint = `${this.baseUrl}/transferInstruments`;
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(transferInstrumentInfo, "TransferInstrumentInfo");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "TransferInstrument");
    }
    /**
    ...
    * @return {@link void }
    */
    async deleteTransferInstrument(id, requestOptions) {
    ...
    * @return {@link TransferInstrument }
    */
    async getTransferInstrument(id, requestOptions) {
        const endpoint = `${this.baseUrl}/transferInstruments/{id}`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
    ...
    * @return {@link TransferInstrument }
    */
    async updateTransferInstrument(id, transferInstrumentInfo, requestOptions) {
        const endpoint = `${this.baseUrl}/transferInstruments/{id}`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(transferInstrumentInfo, "TransferInstrumentInfo");
...
exports.TransferInstrumentsApi = TransferInstrumentsApi;
//# sourceMappingURL=transferInstrumentsApi.js.map