...
class PCIQuestionnairesApi extends service_1.default {
    ...
    */
    async calculatePciStatusOfLegalEntity(id, calculatePciStatusRequest, requestOptions) {
        ...
        const request = objectSerializer_1.ObjectSerializer.serialize(calculatePciStatusRequest, "CalculatePciStatusRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "CalculatePciStatusResponse");
    }
    /**
    ...
    */
    async generatePciQuestionnaire(id, generatePciDescriptionRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/legalEntities/{id}/pciQuestionnaires/generatePciTemplates`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(generatePciDescriptionRequest, "GeneratePciDescriptionRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "GeneratePciDescriptionResponse");
    }
    /**
    ...
    */
    async getPciQuestionnaire(id, pciid, requestOptions) {
        ...
        return objectSerializer_1.ObjectSerializer.deserialize(response, "GetPciQuestionnaireResponse");
    }
    /**
    ...
    */
    async getPciQuestionnaireDetails(id, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "GetPciQuestionnaireInfosResponse");
    }
    /**
    ...
    */
    async signPciQuestionnaire(id, pciSigningRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/legalEntities/{id}/pciQuestionnaires/signPciTemplates`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(pciSigningRequest, "PciSigningRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "PciSigningResponse");
    }
}
