...
const checkoutForwardRequest_1 = require("./checkoutForwardRequest");
const checkoutForwardRequestCard_1 = require("./checkoutForwardRequestCard");
const checkoutForwardRequestOptions_1 = require("./checkoutForwardRequestOptions");
const checkoutForwardResponse_1 = require("./checkoutForwardResponse");
const checkoutForwardResponseFromUrl_1 = require("./checkoutForwardResponseFromUrl");
const checkoutNativeRedirectAction_1 = require("./checkoutNativeRedirectAction");
const checkoutNetworkTokenOption_1 = require("./checkoutNetworkTokenOption");
const checkoutOrderResponse_1 = require("./checkoutOrderResponse");
const checkoutOutgoingForwardRequest_1 = require("./checkoutOutgoingForwardRequest");
...
const externalTokenDetails_1 = require("./externalTokenDetails");
...
const itemDetailLine_1 = require("./itemDetailLine");
const klarnaDetails_1 = require("./klarnaDetails");
const leg_1 = require("./leg");
const levelTwoThree_1 = require("./levelTwoThree");
...
const paymentValidations_1 = require("./paymentValidations");
const paymentValidationsNameRequest_1 = require("./paymentValidationsNameRequest");
const paymentValidationsNameResponse_1 = require("./paymentValidationsNameResponse");
const paymentValidationsNameResultRawResponse_1 = require("./paymentValidationsNameResultRawResponse");
const paymentValidationsNameResultResponse_1 = require("./paymentValidationsNameResultResponse");
const paymentValidationsResponse_1 = require("./paymentValidationsResponse");
...
const responseAdditionalDataSwish_1 = require("./responseAdditionalDataSwish");
...
const shopperName_1 = require("./shopperName");
const shopperTaxInfo_1 = require("./shopperTaxInfo");
...
const tokenMandate_1 = require("./tokenMandate");
...
const upiQrDetails_1 = require("./upiQrDetails");
...
let typeMap = {
    ...
    "CheckoutForwardRequest": checkoutForwardRequest_1.CheckoutForwardRequest,
    "CheckoutForwardRequestCard": checkoutForwardRequestCard_1.CheckoutForwardRequestCard,
    "CheckoutForwardRequestOptions": checkoutForwardRequestOptions_1.CheckoutForwardRequestOptions,
    "CheckoutForwardResponse": checkoutForwardResponse_1.CheckoutForwardResponse,
    "CheckoutForwardResponseFromUrl": checkoutForwardResponseFromUrl_1.CheckoutForwardResponseFromUrl,
    "CheckoutNativeRedirectAction": checkoutNativeRedirectAction_1.CheckoutNativeRedirectAction,
    "CheckoutNetworkTokenOption": checkoutNetworkTokenOption_1.CheckoutNetworkTokenOption,
    "CheckoutOrderResponse": checkoutOrderResponse_1.CheckoutOrderResponse,
    "CheckoutOutgoingForwardRequest": checkoutOutgoingForwardRequest_1.CheckoutOutgoingForwardRequest,
    ...
    "ExternalTokenDetails": externalTokenDetails_1.ExternalTokenDetails,
    ...
    "Item": item_1.Item,
    "ItemDetailLine": itemDetailLine_1.ItemDetailLine,
    "KlarnaDetails": klarnaDetails_1.KlarnaDetails,
    "Leg": leg_1.Leg,
    "LevelTwoThree": levelTwoThree_1.LevelTwoThree,
    ...
    "PaymentValidations": paymentValidations_1.PaymentValidations,
    "PaymentValidationsNameRequest": paymentValidationsNameRequest_1.PaymentValidationsNameRequest,
    "PaymentValidationsNameResponse": paymentValidationsNameResponse_1.PaymentValidationsNameResponse,
    "PaymentValidationsNameResultRawResponse": paymentValidationsNameResultRawResponse_1.PaymentValidationsNameResultRawResponse,
    "PaymentValidationsNameResultResponse": paymentValidationsNameResultResponse_1.PaymentValidationsNameResultResponse,
    "PaymentValidationsResponse": paymentValidationsResponse_1.PaymentValidationsResponse,
    ...
    "ResponseAdditionalDataSwish": responseAdditionalDataSwish_1.ResponseAdditionalDataSwish,
    ...
    "ShopperName": shopperName_1.ShopperName,
    "ShopperTaxInfo": shopperTaxInfo_1.ShopperTaxInfo,
    "Split": split_1.Split,
    ...
    "TokenMandate": tokenMandate_1.TokenMandate,
    ...
    "UpiQrDetails": upiQrDetails_1.UpiQrDetails,
