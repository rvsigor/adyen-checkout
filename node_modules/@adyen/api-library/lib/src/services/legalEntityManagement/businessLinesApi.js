...
exports.BusinessLinesApi = void 0;
 ...
 */
class BusinessLinesApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async createBusinessLine(businessLineInfo, requestOptions) {
        const endpoint = `${this.baseUrl}/businessLines`;
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(businessLineInfo, "BusinessLineInfo");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "BusinessLine");
    }
    /**
    ...
    * @return {@link void }
    */
    async deleteBusinessLine(id, requestOptions) {
    ...
    * @return {@link BusinessLine }
    */
    async getBusinessLine(id, requestOptions) {
        const endpoint = `${this.baseUrl}/businessLines/{id}`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
    ...
    * @return {@link BusinessLine }
    */
    async updateBusinessLine(id, businessLineInfoUpdate, requestOptions) {
        const endpoint = `${this.baseUrl}/businessLines/{id}`
            .replace("{" + "id" + "}", encodeURIComponent(String(id)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(businessLineInfoUpdate, "BusinessLineInfoUpdate");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "PATCH" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "BusinessLine");
    }
}
exports.BusinessLinesApi = BusinessLinesApi;
//# sourceMappingURL=businessLinesApi.js.map