...
class HttpURLConnectionClient {
    ...
    request(endpoint, json, config, isApiRequired, requestOptions) {
        ...
        return this.doRequest(httpConnection, json, (_b = config.enable308Redirect) !== null && _b !== void 0 ? _b : true);
    }
     ...
     */
    doRequest(connectionRequest, json, allowRedirect) {
                ...
                res.on("end", () => {
                    ...
                    if (allowRedirect && res.statusCode && res.statusCode === 308) {
                        ...
                        if (location) {
                            ...
                            try {
                                ...
                                const redirectResponse = this.doRequest(redirectedRequest, json, false);
                    ...
                    if (res.statusCode && (res.statusCode < 200 || res.statusCode >= 300)) {
                        ...
                        try {
                            ...
                            // parsing error
                            exception = new httpClientException_1.default({
                                message: `HTTP Exception: ${response.statusCode}. Error ${e.message} while parsing response: ${response.body}`,
                                statusCode: response.statusCode,
                                responseHeaders: response.headers,
                                responseBody: response.body,
                            });
