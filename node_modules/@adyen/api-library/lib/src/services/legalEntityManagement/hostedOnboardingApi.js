...
class HostedOnboardingApi extends service_1.default {
    ...
    */
    async getLinkToAdyenhostedOnboardingPage(id, onboardingLinkInfo, requestOptions) {
        ...
        const request = objectSerializer_1.ObjectSerializer.serialize(onboardingLinkInfo, "OnboardingLinkInfo");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "OnboardingLink");
    }
    /**
    ...
    */
    async getOnboardingLinkTheme(id, requestOptions) {
        ...
        return objectSerializer_1.ObjectSerializer.deserialize(response, "OnboardingTheme");
    }
    /**
    ...
    */
    async listHostedOnboardingPageThemes(requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "OnboardingThemes");
    }
}
